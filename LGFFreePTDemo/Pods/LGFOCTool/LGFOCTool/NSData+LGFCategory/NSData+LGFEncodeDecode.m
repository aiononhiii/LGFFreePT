...
@implementation NSData (LGFEncodeDecode)

- (NSString *)lgf_Utf8String {
    if (self.length > 0) {
...
+ (NSData *)lgf_DataWithHexString:(NSString *)hexStr {
...
+ (NSData *)lgf_DataWithBase64EncodedString:(NSString *)base64EncodedString {
