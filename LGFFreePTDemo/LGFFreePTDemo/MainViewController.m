...
- (void)viewDidLoad {
    ...
    if (@available(iOS 11.0, *)) {
        self.listCV.contentInsetAdjustmentBehavior = UIScrollViewContentInsetAdjustmentNever;
    } else {
  ...
  @{@"title" : @"渐隐效果",
    @"array" : @[@"1", @"22", @"333", @"4444", @"55555", @"666666", @"77", @"88888888"]},
  @{@"title" : @"挤压",
    @"array" : @[@"宝马", @"奥迪", @"奔驰", @"英菲尼迪", @"吉普", @"马自达", @"丰田", @"大众"]},
  @{@"title" : @"分割线",
    @"array" : @[@"模块一", @"模块二", @"模块三", @"模块四", @"模块五", @"模块六", @"模块七"]},
  @{@"title" : @"部分需求效果",
  ...
  @{@"title" : @"可视化打造 style",
    @"array" : @[@"我的", @"邮箱", @"452354033@qq.com", @"有", @"BUG", @"可以", @"联系我", @"我的", @"邮箱", @"452354033@qq.com", @"有", @"BUG", @"可以", @"联系我", @"我的", @"邮箱", @"452354033@qq.com", @"有", @"BUG", @"可以", @"联系我"]}
  ];
