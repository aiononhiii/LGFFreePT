...
@implementation UIScreen (LGFScreen)
...
- (CGRect)lgf_CurrentBounds {
    return [self lgf_BoundsForOrientation:[[UIApplication sharedApplication] statusBarOrientation]];
}
#endif
...
- (CGSize)lgf_SizeInPixel {
    CGSize size = CGSizeZero;
    
    if ([[UIScreen mainScreen] isEqual:self]) {
        NSString *model = [UIDevice currentDevice].lgf_MachineModel;
