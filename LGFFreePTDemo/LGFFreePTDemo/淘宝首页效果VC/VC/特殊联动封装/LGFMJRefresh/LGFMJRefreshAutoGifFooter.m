...
#import "LGFMJRefreshAutoGifFooter.h"

@interface LGFMJRefreshAutoGifFooter()
{
...
@implementation LGFMJRefreshAutoGifFooter
#pragma mark - 懒加载
- (UIImageView *)gifView
{
    if (!_gifView) {
...
- (void)placeSubviews
{
    ...
    if (self.isRefreshingTitleHidden) {
        ...
        self.gifView.lgfmj_w = self.lgfmj_w * 0.5 - self.labelLeftInset - self.stateLabel.lgfmj_textWith * 0.5;
    }
}
