...
- (IBAction)getLGFFreePTStyleDemo:(id)sender {
    ...
    [styleDefultDict.allKeys enumerateObjectsUsingBlock:^(NSString * _Nonnull defultKey, NSUInteger idx, BOOL * _Nonnull stop) {
        if (![[styleDefultDict valueForKey:defultKey] isEqualToString:[styleDict valueForKey:defultKey]]) {
            NSString *demo = @"";
...
- (void)setDefultStyle {
    ...
    self.lgf_TitleBorderWidth.text = styleDict[@"lgf_TitleBorderWidth"] ? styleDict[@"lgf_TitleBorderWidth"] : [NSString stringWithFormat:@"%.1f", style.lgf_TitleBorderWidth];
    self.lgf_PVTitleViewBackgroundColor.text = styleDict[@""] ? styleDict[@""] : [style.lgf_PVTitleViewBackgroundColor lgf_HexStringWithAlpha];
    self.lgf_TitleSelectFont.text = styleDict[@"lgf_TitleSelectFont"] ? styleDict[@"lgf_TitleSelectFont"] : [NSString stringWithFormat:@"%.1f", style.lgf_TitleSelectFont.pointSize];
    self.lgf_UnTitleSelectFont.text = styleDict[@"lgf_UnTitleSelectFont"] ? styleDict[@"lgf_UnTitleSelectFont"] : [NSString stringWithFormat:@"%.1f", style.lgf_UnTitleSelectFont.pointSize];
    self.lgf_SubTitleSelectFont.text = styleDict[@"lgf_SubTitleSelectFont"] ? styleDict[@"lgf_SubTitleSelectFont"] : [NSString stringWithFormat:@"%.1f", style.lgf_SubTitleSelectFont.pointSize];
    ...
    self.lgf_PageLeftRightSpace.text = styleDict[@"lgf_PageLeftRightSpace"] ? styleDict[@"lgf_PageLeftRightSpace"] : [NSString stringWithFormat:@"%.1f", style.lgf_PageLeftRightSpace];
...
- (LGFFreePTStyle *)getNewStyle {
    ...
    if (self.lgf_IsDoubleTitle.on) {
        style.lgf_Titles = @[@"我的/我的", @"邮箱:/邮箱:", @"452354033@qq.com/452354033@qq.com", @"正在/正在", @"寻求好的/寻求好的", @"团队/团队", @"从事过 IOS 开发/Android 开发/从事过 IOS 开发/Android 开发", @"主要从事/主要从事", @"IOS 开发/IOS 开发", @"5/5", @"年半开发经验/年半开发经验"].copy;
    } else {
