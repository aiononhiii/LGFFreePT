...
//********************** 帮助 ***************************
// 本控件是一个特殊的分页控件，实现了 title 和 page 的分离，方便一些喜欢自由搭配的产品，主要为一些复杂的页面布局而打造
// 由于和分页控件分离，具体用法请一定参考该项目 https://github.com/aiononhiii/LGFFreePT
// 本控件已经支持cocoapods, 导入方法在Podfile文件里加入：pod 'LGFFreePT'
// 有问题可以在github上提给我哦～
// 也可以发我邮箱 452354033@qq.com
// 本人现生活在杭州，正在寻找靠谱的开发团队
//******************************************************
